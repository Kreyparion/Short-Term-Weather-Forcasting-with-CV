...
#########
#########
nbjours = 50  # on peut aller jusqu'à 124  (nombre de jours en banque de données à partir du 30 mai)
...
t = tableau_images("./Images/VIS8_MSG4-SEVI-MSG15-0100-NA-2019", "jpg", nbjours, 8, 9, (9, 42), (16, 28), (120,20),
...
#bloc conv 1
conv_layer1 = tf.keras.layers.Conv3D(16, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    tf_input)  # 218
print('conv_layer1 : ' + str(conv_layer1.shape))
normac1 = tf.keras.layers.BatchNormalization()(conv_layer1)
conv_layer2 = tf.keras.layers.Conv3D(16, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    normac1)  # 216
...
#bloc conv 2
conv_layer3 = tf.keras.layers.Conv3D(32, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    normap1)  # 106
print('conv_layer3 : ' + str(conv_layer3.shape))
normac3 = tf.keras.layers.BatchNormalization()(conv_layer3)
conv_layer4 = tf.keras.layers.Conv3D(32, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    normac3)  # 104
...
#bloc conv 3
conv_layer5 = tf.keras.layers.Conv3D(64, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    normap2)  # 50
print('conv_layer5 : ' + str(conv_layer5.shape))
normac4 = tf.keras.layers.BatchNormalization()(conv_layer5)
conv_layer6 = tf.keras.layers.Conv3D(64, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    normac4)  # 48
...
#bloc déconv 3
upool_layer3 = tf.keras.layers.Conv3DTranspose(64, (1, 4, 4), strides=(1, 2, 2), activation='relu', data_format="channels_last")(normap3) # 24 -> 50
print('upool_layer3 : ' + str(upool_layer3.shape))
normau3 = tf.keras.layers.BatchNormalization()(upool_layer3)
deconv_layer3 = tf.keras.layers.Conv3DTranspose(64, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(normau3)  # 50 -> 52
print('deconv_layer3 : ' + str(deconv_layer3.shape))
normad3 = tf.keras.layers.BatchNormalization()(deconv_layer3)
#bloc déconv 2
upool_layer2 = tf.keras.layers.Conv3DTranspose(32, (1, 4, 4), strides=(1, 2, 2), activation='relu', data_format="channels_last")(normad3) # 52 -> 2014
print('upool_layer2 : ' + str(upool_layer2.shape))
normau2 = tf.keras.layers.BatchNormalization()(upool_layer2)
deconv_layer2 = tf.keras.layers.Conv3DTranspose(32, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(normau2)  # 218 -> 220
print('deconv_layer2 : ' + str(deconv_layer2.shape))
normad2 = tf.keras.layers.BatchNormalization()(deconv_layer2)
#bloc déconv 1
upool_layer1 = tf.keras.layers.Conv3DTranspose(16, (1, 4, 4), strides=(1, 2, 2), activation='relu', data_format="channels_last")(normad2) # 108 -> 218
