...
def dist_image(impath, imtemps, imradical1, imradical2, imtype):
    ...
    print("NEW MSE2 : " + imtemps + imradical1 + "<->" + imradical2 + " = " + str(im_new_mse))
    print("NEW SSIM : " + imtemps + imradical1 + "<->" + imradical2 + " = " + str(im_new_ssim))
...
conv_layer7 = tf.keras.layers.Conv3D(4*nbfiltreini, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(
    conv_layer6)  # 46
...
#bloc déconv 3
upool_layer3 = tf.keras.layers.Conv3DTranspose(4*nbfiltreini, (1, 4, 4), strides=(1, 2, 2), activation='relu', data_format="channels_last")(pool_layer3) # 23 -> 48
...
deconv_layer3 = tf.keras.layers.Conv3DTranspose(4*nbfiltreini, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(deconv_layer4)  # 50 -> 52
#print('deconv_layer3 : ' + str(deconv_layer3.shape))
#normad3 = tf.keras.layers.BatchNormalization()(deconv_layer3)
#bloc déconv 2
upool_layer2 = tf.keras.layers.Conv3DTranspose(2*nbfiltreini, (1, 4, 4), strides=(1, 2, 2), activation='relu', data_format="channels_last")(deconv_layer3) # 52 -> 2014
#print('upool_layer2 : ' + str(upool_layer2.shape))
#normau2 = tf.keras.layers.BatchNormalization()(upool_layer2)
deconv_layer2 = tf.keras.layers.Conv3DTranspose(2*nbfiltreini, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(upool_layer2)  # 218 -> 220
...
deconv_layer1 = tf.keras.layers.Conv3DTranspose(1, (1, 3, 3), strides=(1, 1, 1), activation='relu', data_format="channels_last")(upool_layer1)  # 218 -> 220
...
single_step_model.save_weights('./Model-Res/Weights/' + Temps +"/" + Temps + '-c7m3')
    # sauvegarde du modèle entier
single_step_model.save('./Model-Res/' + Temps + '-c7m3.h5')
