...
t = tableau_images("./Images/Total/VIS8_MSG4-SEVI-MSG15-0100-NA-2019", "jpg", nbjours, 8, 7, (9, 42), (17, 28), (750,750),
...
single_step_model.compile(optimizer='rmsprop', loss='mse' , metrics=['mae', 'mse', 'msle', 'acc', 'mape'])
